...
-- 4. Create policy to allow Match Directors to upload/insert assets for their own matches (safe text comparison)
...
-- 5. Create policy to allow Match Directors to update assets for their own matches (safe text comparison)
...
-- 6. Create policy to allow Match Directors to delete assets for their own matches (safe text comparison)
